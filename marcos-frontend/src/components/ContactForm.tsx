    ...
    return (
        <section id="contact" className="py-20 px-6 w-full max-w-2xl md:max-w-4xl mx-auto border-t-2 border-black mt-20 scroll-mt-48">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 md:gap-10">
                ...
                <button
                    type="submit"
                    className="self-start mt-4 bg-black text-white px-10 md:px-14 py-3 md:py-5 uppercase text-sm md:text-xl font-poetsen font-normal tracking-widest hover:text-accent transition-colors"
                >
                    Submit
                </button>
